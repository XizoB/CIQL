...
if [ ! -f ${XAUTH} ]; then
    ...
    if [ -n "${XAUTH_LIST}" ]; then
        ...
        XAUTH_LIST=$python /root/RoboLearn/Test/Test_launch/collect_human_demonstrations.py --directory /root/RoboLearn/Test/Test_launch/Data_train/collect_demonstration --robots IIWA --environment StackObstacle --device omega
(sed -e 's/^..../ffff/' <<<"${XAUTH_LIST}")
...
CUSTOM_VOLUMES+=("/home/dell/Xizobu/Docker_RoboLearn:/root/Docker_RoboLearn")
# USB Hot swapping
